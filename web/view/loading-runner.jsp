...
<!-- ⭐ RUNNER LOADER — Hiển thị khi trang đang load -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/style/runner-loader.css">
...
<div class="page-loading" id="pageLoading">
    ...
    <div class="loading-text">
        <span>Đ</span><span>A</span><span>N</span><span>G</span>
        <span>&nbsp;</span>
        <span>T</span><span>Ả</span><span>I</span>
    </div>
