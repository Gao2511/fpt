    ...
    <div class="container">
        ...
        <div class="detail-block">
            ...
            <form action="${pageContext.request.contextPath}/ContactServlet" method="POST" class="quick-contact-form">
                ...
                <textarea name="user_note" placeholder="Ghi chú (không bắt buộc)"></textarea>
    ...
    (function() {
        ...
        quickForm.addEventListener('submit', function(e) {
            ...
            if (addressInput.value.trim() === '') {
                e.preventDefault();
                showError(addressInput, 'Vui lòng nhập địa chỉ lắp đặt!');
                return false;
            }
        ...
        function showError(input, message) {
            ...
            // Xóa highlight khi user bắt đầu nhập
